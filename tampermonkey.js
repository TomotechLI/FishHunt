...
(function() {
    ...
    document.querySelector("#topnav").setAttribute("wc_remove", "");
    document.querySelector("#header").setAttribute("wc_remove", "");
    document.querySelector("#nav").setAttribute("wc_remove", "");
    document.querySelector("#calltoaction").setAttribute("wc_remove", "");
    document.querySelector("#footer").setAttribute("wc_remove", "");
    document.querySelector("#content > div:nth-child(2)").setAttribute("wc_remove", "");
